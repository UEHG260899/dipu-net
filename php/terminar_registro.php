            ...
            <div class="col-12">
                <div class="panel-formulario">
                    <form action="terminar_registro.php" method="POST" id="formFinRegistro">
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6 leftToRight">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 rightToLeft">
                                <div class="form-group">
                        ...
                        <div class="row text-right">
                            <div class="col-12">
                                <button class="btn bg-boton rightToLeft" type="button" id="btnFinaliza">Guardar datos</button>
                            </div>
                        </div>
                    </form>
                </div>
