                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-3">
                            ...
                            <input type="text" class="form-control" id="nombreCan" placeholder="Ingrese nombre del candidato">
                        </div>


                        <div class="form-group col-3">
                            <label class="font-weight-bold" for="apPatCan">Apellido Peterno</label>
                            <input type="text" class="form-control" id="apPatCan" placeholder="Ingrese apellido paterno del candidato">
                        </div>

                        <div class="form-group col-3">
                            <label class="font-weight-bold" for="apMatCan">Apellido Materno</label>
                            <input type="text" class="form-control" id="apMatCan" placeholder="Ingrese apellido materno del candidato">
                        </div>

                        <div class="form-group col-3">
                            <label class="font-weight-bold" for="generoCan">Genero</label>
                            <select id="generoCan" class="form-control">
                    ...
                    <div class="form-row mb-4">
                        <div class="form-group col-3">
                            ...
                            <select id="estadoCan" class="form-control">
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="municipioCan" class="form-control">
                        ...
                        <div class="form-group col-3">
                            ...
                            <input type="date" class="form-control" id="nacimientoCan" placeholder="">
                        </div>

                        <div class="form-group col-3">
                            <label class="font-weight-bold" for="imgCan">Imagen</label>
                            <input type="text" class="form-control" id="imgCan" placeholder="Ingrese nombre de la imagen">
                        </div>
                    </div>
                    ...
                    <div class="form-row mb-4">
                        <div class="form-group col-4">
                            ...
                            <select id="partidoCan" class="form-control">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select id="institucionCan" class="form-control">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="number" class="form-control" id="distritoCan" placeholder="0">
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row mb-4">
                        <div class="form-group col-4">
                            ...
                            <select id="gradoCan" class="form-control">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="text" class="form-control" id="institucionCan" placeholder="Ingrese Institución donde se formo el candidato">
                        </div>

                        <div class="form-group col-4">
                            <label class="font-weight-bold" for="puestoCan">Puesto actual</label>
                            <input type="text" class="form-control" id="puestoCan" placeholder="Ingrese que puesto laboral actual del condidato">
                        </div>
                    </div>
