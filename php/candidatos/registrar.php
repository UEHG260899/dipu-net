                    ...
                    <div class="form-row">
                        <div class="form-group col-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control validar" id="nombreCan" name="nombreCan" placeholder="Ingrese nombre del candidato">
                        ...
                        <div class="form-group col-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control validar" id="apPatCan" name="apPatCan" placeholder="Ingrese apellido paterno del candidato">
                        ...
                        <div class="form-group col-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control validar" id="apMatCan" name="apMatCan" placeholder="Ingrese apellido materno del candidato">
                        ...
                        <div class="form-group col-3">
                            ...
                            <div class="input-group">
                                ...
                                <select id="generoCan" name="generoCan" class="form-control validar">
                    ...
                    <div class="form-row mb-4">
                        <div class="form-group col-3">
                            ...
                            <div class="input-group">
                                ...
                                <select id="estadoCan" name="estadoCan" class="form-control validar">
                                    <option disabled hidden selected value="0">Seleccione una opcion</option>
                        ...
                        <div class="form-group col-3">
                            ...
                            <div class="input-group">
                                ...
                                <select id="municipioCan" name="municipioCan" class="form-control validar">
                        ...
                        <div class="form-group col-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control validar" id="nacimientoCan" name="nacimientoCan" placeholder="">
                        ...
                        <div class="form-group col-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control validar" id="imgCan" name="imgCan" placeholder="Ingrese nombre de la imagen">
                    ...
                    <div class="form-row mb-4">
                        <div class="form-group col-4">
                            ...
                            <div class="input-group">
                                ...
                                <select id="partidoCan" name="partidoCan" class="form-control validar">
                        ...
                        <div class="form-group col-4">
                            ...
                            <div class="input-group">
                                ...
                                <select id="tipoCan" name="tipoCan" class="form-control validar">
                        ...
                        <div class="form-group col-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control validar" id="distritoCan" name="distritoCan" placeholder="Número de distrito">
                    ...
                    <div class="form-row mb-4">
                        ...
                        <div class="form-group col-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control validar" id="institucionCan" name="institucionCan" placeholder="Ingrese Institución donde se formo el candidato">
                        ...
                        <div class="form-group col-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control validar" id="puestoCan" name="puestoCan" placeholder="Ingrese que puesto laboral actual del condidato">
...
if (array_key_exists('id', $_GET)) {
    ...
    echo '<script src="' . $root . "/js/candidatos/editar.js" . '"></script>';
} else {
